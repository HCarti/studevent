...
const Organizations = () => {
  ...
  const handleCardClick = (org) => {
    setSelectedOrg(org);
    setModalOpen(true);
    setViewAll(false); // Ensure this is reset when viewing a single organization
  };
  ...
  return (
    <div className="organizations-page">
      ...
      <div className="view-all-container">
        <button className="view-all-btn" onClick={() => { setModalOpen(true); setViewAll(true); }}>
      ...
      {isModalOpen && (
        <Modal
          ...
          allOrganizations={viewAll ? organizations : null} // Pass all organizations if viewAll is true
        />
      )}
